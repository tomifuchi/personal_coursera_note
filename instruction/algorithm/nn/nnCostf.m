...
%   of each theta, ascending. col 1 for number of rows, col 2 for collumns
%   * X: Input matrix, not biased(No 1's collumn at start).
%   * y: output
...
%   * Cross-checking gradient using check_gradient
%
%   Output:
%   J : cost 
